...
contract WithdrawTest is Test {
    ...
    // REMOVED multi withdraw not allowed
    ...
    // function testWithdrawKnife() public {
    //     uint amount_staked = stakedKnife.balanceOf(address(this));
    //     uint256 tokenId = stakedKnife.tokenIdsOfUser(address(this))[0];
    //     vm.warp(block.timestamp + 20);
    //     stakedKnife.withdraw(tokenId);
    //     assertTrue(knife.balanceOf(address(this)) == 1);
    //     assertTrue(stakedKnife.balanceOf(address(this)) == amount_staked - 1);
    // }
...
contract MPLGCYTest is Test {
    ...
    //     vm.expectRevert(bytes("Spend some tokens first."));
    //     stakedKnife.withdraw(stakedTokenIds[0]);
